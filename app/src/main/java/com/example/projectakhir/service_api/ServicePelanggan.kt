...
interface PelangganService {
    ...
    @GET("pelanggan/{id_pelanggan}")  // Perbaiki path dengan /api/pelanggan/{id_pelanggan}
    ...
    @PUT("pelanggan/{id_pelanggan}")  // Perbaiki path dengan /api/pelanggan/{id_pelanggan}
    ...
    @DELETE("pelanggan/{id_pelanggan}")  // Perbaiki path dengan /api/pelanggan/{id_pelanggan}
